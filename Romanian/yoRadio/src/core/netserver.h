...
<title>Interfață Web de incărcat fișierele necesare yoRadio</title>
<style>body{background-color:#000;color:#e3d25f;font-size:20px;}
hr{margin:20px 0;border:0; border-top:#555 1px solid;} 
...
<section>
<h2>Interfață Web de incărcat fișierele necesare yoRadio</h2>
<hr />
<span>Selectează <u>TOATE</u> fișierele din <i>yoRadio/data/www/</i><br />și încarcă-le folosind formularul de mai jos</span>
<hr />
<form action="/%ACTION%" method="post" enctype="multipart/form-data">
<p><label for="www">www:</label> <input type="file" name="www" id="www" multiple></p>
<hr />
<span>-= OPTIONAL =-<br />De asemenea, puteți încărca <i>playlist.csv</i><br />and <i>wifi.csv files</i> din backup-ul dvs.</span>
...
<hr />
<form action="/%ACTION%" method="post" enctype="multipart/form-data">
<span>-= OPTIONAL =-<br />Dacă nu vă puteți conecta de la PC la adresa 192.168.4.1<br />configurați mai întâi conexiunea WiFi</span>
...
<p><input type="submit" name="submit" value="Salvați datele rețelei wifi."></p>
</form>
</div>
</section>
</body></html>
